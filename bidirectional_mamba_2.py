i# modified from https://github.com/state-spaces/mamba/blob/main/mamba_ssm/modules/mamba2_simple.py <3
...
class Bidirectional_Mamba_2(nn.Module):
    def __init__(
        self,
        d_model,
        d_state=128,
        ...
        self.A_log_b = nn.Parameter(A_log)
        ...
        if self.process_group is None:
            ...
            self.out_proj = RowParallelLinear(self.d_inner * self.world_size, self.d_model, bias=bias,
                                              process_group=self.process_group, sequence_parallel=self.sequence_parallel,
                                              **factory_kwargs)
            self.out_proj_b = RowParallelLinear(self.d_inner * self.world_size, self.d_model, bias=bias,
                                              process_group=self.process_group, sequence_parallel=self.sequence_parallel,
                                              **factory_kwargs)
